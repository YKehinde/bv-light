...
module.exports = {
    ...
    // (using 'data-grunticon-embed' attributes in the markup)
    enhanceSVG: false,
    ...
    // of the CSS. If you don't want a prefix path, set this to ''
    cssbasepath: '/',
    ...
    template: _path.join( __dirname, 'default-css.hbs' ),
    previewTemplate: _path.join( __dirname, 'preview-custom.hbs' ),
